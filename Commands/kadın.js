...
let uyarıembed = new MessageEmbed().setColor(Settings.Colors.Red)
let user = message.mentions.members.first() || message.guild.members.cache.get(args[0])
let isim = args[1]
let yaş = args[2]
let uyarıembed = new MessageEmbed().setColor(Settings.Colors.Red).setFooter("Losint ♥ Arsen").setTimestamp()
